# Send SMS and MMS messages when timed conditions are met.

import email
import smtplib
import ssl
from providers import PROVIDERS
from DayCounter import check_date

# used for MMS
'''from email import encoderscd
...
def main():
    ...
    sender_credentials = ("ostrichontherun@gmail.com", "zhmfjwfqglidnytf")

    # Check date

    check_date()
    '''if check_date().today == "2022-10-08":
        print("test passed!")
    else:
        print("fail!")'''
